...
Animate( )
{
	...
	BladeMain = Time * 360 * 40;
	BladeTail = Time * 360 * 120;
...
Display( )
{
	...
	if (ViewOn)
	{
		gluLookAt(-0.4, 1.8, -4.9, 0., 0., -100., 0., 1., 0.);
	}
	else 
	{

		gluLookAt(12., 5., 12., 0., 0., 0., 0., 1., 0.);
	}
	...
	glRotatef(BladeMain, 0.0, 0.0, 1.0);
	...
	glRotatef(BladeTail, 0.0, 0.0, 1.0);
