...
Animate( )
{
	...
	Time_Sine = Time * 360;
	Time_Sine = sin(Time_Sine * 3.14 / 180);
	S0 = abs(Time_Sine);
	T0 = Time_Sine;
	D0 = abs(Time_Sine)/6;
	T0 = Time_Sine;
...
Display( )
{
	...
	if (Animate_Both)
	{
		Pattern->SetUniformVariable("uA", S0);
		Pattern->SetUniformVariable("uRadius", D0);
		Pattern->SetUniformVariable("uS0", SU0);
		Pattern->SetUniformVariable("uT0", TU0);
	}
	else if (Animate_Frag) 
	{
		S0 = 1.;
		T0 = 0.;
		Pattern->SetUniformVariable("uRadius", D0);
	...
	else if (Animate_Vertex) 
	{
		D0 = .1;
		Pattern->SetUniformVariable("uA", S0);
		Pattern->SetUniformVariable("uB", T0);
		Pattern->SetUniformVariable("uRadius", D0);
		Pattern->SetUniformVariable("uS0", SU0);
		Pattern->SetUniformVariable("uT0", TU0);
	}
...
Keyboard( unsigned char c, int x, int y )
{
	...
	switch( c )
	{
		...
		case 'b':
			...
			Animate_Vertex = 0;
			Frozen_Both = 0;
			printf("NOW ANIMATING BOTH\n");
			break;

		case 'V':
			Animate_Vertex = !Animate_Vertex;
			Animate_Both = 0;
			Animate_Frag = 0;
			Frozen_Both = 0;
			printf("NOW ANIMATING ONLY VERTEX\n");
			break;
		...
		case 'f':
			...
			{
				glutIdleFunc(NULL);
				printf("NOW FREEZING BOTH\n");
			}
			else
			{
				glutIdleFunc(Animate);
				printf("NOW ANIMATING BOTH THROUGH f\n");
			}
			break;

		case 'F':
			Animate_Frag = !Animate_Frag;
			Animate_Both = 0;
			Frozen_Both = 0;
			Animate_Vertex = 0;
			printf("NOW ANIMATING ONLY FRAG\n");
			break;
